...
import io.ledgerwise.ipfsresizer.helper.icafe4j.util.Reader;
...
public class SOFReader implements Reader {
	...
	private static final EnumSet<Marker> SOFS = EnumSet.of(Marker.SOF0, Marker.SOF1, Marker.SOF2, Marker.SOF3,
			Marker.SOF5,
