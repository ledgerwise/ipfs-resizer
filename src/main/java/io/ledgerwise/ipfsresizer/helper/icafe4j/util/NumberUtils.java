...
public class NumberUtils {
     ...
     * it removes them. If argument is float or double then no change in return
     * type.
    ...
    public static String changeToDecimalFormat(Object number) {
        ...
        String pattern = "###,##0.0###########"; // To apply formatting when the number of digits in input equals the
                                                 // pattern
