...
package io.ledgerwise.ipfsresizer.helper.icafe4j.image.meta.png;
...
import io.ledgerwise.ipfsresizer.helper.icafe4j.image.png.TIMEReader;
...
public class TIMEChunk extends Metadata {
	...
	private static final String[] MONTH = { "", "January", "Febrary", "March", "April",
	...
	public Iterator<MetadataEntry> iterator() {
		...
		entries.add(new MetadataEntry("UTC (Time of last modification)",
				day + " " + ((month > 0 && month <= 12) ? MONTH[month] : "()") + " " + year + ", " + hour + ":" + minute
						+ ":" + second));
