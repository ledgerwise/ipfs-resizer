...
package io.ledgerwise.ipfsresizer.helper.icafe4j.image.meta.xmp;
...
public abstract class XMP extends Metadata {
	 ...
	 * 
	 * @return a merged Document for the entire XMP data with the GUID from the
	 *         standard XMP document removed
	 */
