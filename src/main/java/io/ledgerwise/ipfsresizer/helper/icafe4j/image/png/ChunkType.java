...
public enum ChunkType {
	...
	TRNS("tRNS", 0x74524E53, Attribute.ANCILLARY, 50), // Must precede the first IDAT chunk and must follow the PLTE
																		// chunk
	...
	BKGD("bKGD", 0x624B4744, Attribute.ANCILLARY, 50), // Must precede the first IDAT chunk and must follow the PLTE
																		// chunk
	...
	HIST("hIST", 0x68495354, Attribute.ANCILLARY, 50), // Must precede the first IDAT chunk and must follow the PLTE
																		// chunk
	...
	public enum Attribute {
		CRITICAL {
			public String[] getNames() {
				// Use clone() to prevent users from changing the values of the internal array
				// elements
