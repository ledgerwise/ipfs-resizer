...
import io.ledgerwise.ipfsresizer.helper.icafe4j.image.reader.GIFReader;
...
public class FrameReader extends GIFReader {
	...
	public GIFFrame getGIFFrame(InputStream is) throws Exception {
		...
		return (bi != null)
				? new GIFFrame(bi, image_x, image_y, delay, disposalMethod, userInputFlag, transparencyFlag,
						transparent_color)
				: null;
	}
