...
public class HuffmanTbl {
	...
	// Generation of table of Huffman codes (CCITT Rec. T.81(1993 E) Annex C, Page
	// 52, Figure C.2)
	...
	// Generate decoder tables (CCITT Rec. T.81(1993 E) Annex F, Page 108, Figure
	// F.15)
	...
	// Generation of table of Huffman code size (CCITT Rec. T.81(1993 E) Annex C,
	// Page 51, Figure C.1)
