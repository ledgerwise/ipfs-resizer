...
import static io.ledgerwise.ipfsresizer.helper.icafe4j.image.gif.GIFTweaker.*;
...
public class GIFWriter extends ImageWriter {
	...
	public void writeAnimatedGIF(BufferedImage[] images, int[] delays, OutputStream os) throws Exception {
		...
		for (int i = 0; i < images.length; i++) {
			...
			int[] pixels = IMGUtils.getRGB(images[i]);// images[i].getRGB(0, 0, imageWidth, imageHeight, null, 0,
																	// imageWidth);
	...
	public void writeAnimatedGIF(GIFFrame[] frames, OutputStream os) throws Exception {
		...
		for (int i = 0; i < frames.length; i++) {
			...
			int[] pixels = IMGUtils.getRGB(frames[i].getFrame());// images[i].getRGB(0, 0, imageWidth, imageHeight, null,
																					// 0, imageWidth);
