...
package io.ledgerwise.ipfsresizer.helper.icafe4j.image;
...
import io.ledgerwise.ipfsresizer.helper.icafe4j.image.quant.QuantQuality;
...
public class ImageParam {
	...
	// DEFAULT_IMAGE_PARAM is immutable given the fact the arrays it contains are
	// empty
	 ...
	 * Only a few image formats support full alpha channel among which are PNG, TGA,
	 * and TIFF.
	 */
