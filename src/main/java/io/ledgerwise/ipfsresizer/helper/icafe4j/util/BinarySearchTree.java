...
public class BinarySearchTree<E extends Comparable<? super E>> {
    ...
    BinaryTreeNode<E> insert(E val, BinaryTreeNode<E> n) {
        if (n == null)
            ...
            for (parent = null, curr = n; (curr != null)
                    && (val.compareTo(curr.val) != 0); parent = curr, curr = (val.compareTo(curr.val)) < 0 ? curr.left
                            : curr.right)
                ;
    ...
    BinaryTreeNode<E> find(E val, BinaryTreeNode<E> n) {
        for (; (n != null) && (val.compareTo(n.val) != 0); n = val.compareTo(n.val) < 0 ? n.left : n.right)
            ;
        return n;
    }
