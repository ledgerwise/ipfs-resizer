...
package io.ledgerwise.ipfsresizer.helper.icafe4j;
...
public final class ImageIO {
	 ...
	 * require random access while reading. In those cases, using a
	 ...
	 * 
	 * @param peekHeadInputStream A PeekHeadInputStream wrapper for the image input
	 *                            stream
	...
	public static void write(BufferedImage img, OutputStream os, ImageType imageType, ImageParam imageParam)
			throws Exception {
