...
public class TIMEBuilder extends ChunkBuilder implements Builder<Chunk> {
	 ...
	 * <p>
	 * The tIME chunk gives the time of the last image modification (not the time of
	 * initial image creation). It contains:
	 * 
	 * <pre>
	...
	protected byte[] buildData() {
		return new byte[] { (byte) (year >>> 8), (byte) year, (byte) month, (byte) day, (byte) hour, (byte) minute,
				(byte) second };
	}
}
