...
public class TextBuilder extends ChunkBuilder implements Builder<Chunk> {
	 ...
	 * <p>
	 * Note also that the non-breaking space (code 160) is not permitted in
	 * keywords,
	...
	/**
	 * The tExt chunk is interpreted according to the ISO/IEC 8859-1 (Latin-1)
	 * character
	 * set [ISO/IEC-8859-1].
	 * 
	 * The text string can contain any Latin-1 character. Newlines in the text
	 * string
	 * should be represented by a single line feed character (decimal 10); use of
	 * other
	 ...
	 * textual
	 * data is in the UTF-8 encoding of the Unicode character set instead of
	 * Latin-1.
	 * This chunk contains:
	 * Keyword: 1-79 bytes (character string)
	 * Null separator: 1 byte
