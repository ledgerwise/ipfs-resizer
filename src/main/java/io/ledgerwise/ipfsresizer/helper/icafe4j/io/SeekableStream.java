 ...
 * 
 * <p>
 * The <code>DataInput</code> interface is supported as well. This included
 * the <code>skipBytes()</code> and <code>readFully()</code> methods and a
 * variety of <code>read</code> methods for various data types.
 *
 * <p>
 * A number of concrete subclasses of <code>SeekableStream</code> are
 ...
 *
 * <p>
 * The <code>SegmentedSeekableStream</code> class performs a different sort
 ...
 *
 * <p>
 * A convenience methods, <code>wrapInputStream</code> is provided to
...
public abstract class SeekableStream extends InputStream implements DataInput {
     ...
     *
     * <p>
     * If <code>canSeekBackwards()</code> returns <code>false</code>,
