...
public enum ColorSpaceID {
	...
	// They are full unsigned 16-bit values. 0 = 100% ink. For example, pure cyan =
	// 0,65535,65535,65535.
	...
	// Lightness is a 16-bit value from 0...10000. Chrominance components are each
	// 16-bit values from -12800...12700.
	// Gray values are represented by chrominance components of 0. Pure white =
	// 10000,0,0.
